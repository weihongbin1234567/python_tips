...
from utils.config import CVC_300,CVC_ClinicDB,CVC_ColonDB,ETIS_LaribPolypDB,Kvasir,video
...
# to_test = {'CVC_300':CVC_300,'ColonDB':CVC_ColonDB,'ClinicDB':CVC_ClinicDB,'ETIS':ETIS_LaribPolypDB,'Kvasir':Kvasir}
to_test = {'video':video }
