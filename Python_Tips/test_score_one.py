...
dataset_rootpath_pre = "/data/whb/DDPM/MID/pixel_classifiers/polyp/ddpm/50_150_250_5_6_7_8_12/visualizations"

name = 'kvasir200'
gt_path = '/data/whb/Kvasir/kvasir_small/Test/masks'    
def test():
    print("this is test")
